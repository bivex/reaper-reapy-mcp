...
class AdvancedRoutingController:
    ...
    def create_bus_track(self, name: str = "Bus Track") -> int:
        ...
        try:
            ...
            RPR.SetMediaTrackInfo_Value(track.id, "I_FOLDERDEPTH", 0)
    ...
    def get_track_children(self, parent_track_index: int) -> List[int]:
        ...
        try:
            ...
            children = []
            parent_depth = RPR.GetMediaTrackInfo_Value(project.tracks[parent_track_index].id, "I_FOLDERDEPTH")
            ...
            for i in range(parent_track_index + 1, len(project.tracks)):
                ...
                track_depth = RPR.GetMediaTrackInfo_Value(track.id, "I_FOLDERDEPTH")
    ...
    def set_track_folder_depth(self, track_index: int, depth: int) -> bool:
        ...
        try:
            ...
            track = project.tracks[track_index]
            RPR.SetMediaTrackInfo_Value(track.id, "I_FOLDERDEPTH", depth)
    ...
    def get_track_folder_depth(self, track_index: int) -> int:
        ...
        try:
            ...
            track = project.tracks[track_index]
            depth = RPR.GetMediaTrackInfo_Value(track.id, "I_FOLDERDEPTH")
