...
class TrackController:
    ...
    def set_track_volume(self, track_index: int, volume_db: float) -> bool:
        ...
        try:
            ...
            if volume_db <= SILENCE_THRESHOLD_DB:  # Treat as -inf dB
                ...
                linear_volume = DB_VOLUME_CONVERSION_FACTOR ** (
                    volume_db / DB_CONVERSION_FACTOR
                )

            # Set volume using ReaScript API for more precise control
            reapy.reascript_api.SetMediaTrackInfo_Value(
                track.id, "D_VOL", linear_volume
            )
    ...
    def get_track_volume(self, track_index: int) -> float:
        ...
        try:
            ...
            linear_volume = reapy.reascript_api.GetMediaTrackInfo_Value(
                track.id, "D_VOL"
            )
    ...
    def get_track_arm(self, track_index: int) -> bool:
        ...
        try:
            ...
            arm_value = reapy.reascript_api.GetMediaTrackInfo_Value(
                track.id, "I_RECARM"
            )
